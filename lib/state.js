...
function defaultState() {
  return { recents: [], favorites: [], overrides: {}, sortBy: 'name' };
}
...
module.exports = { read, write, addRecent, removeRecent, addFavorite, removeFavorite, setOverride, clearOverride, setSortBy };
