...
function defaultState() {
  return { recents: [], favorites: [], overrides: {}, sortBy: 'name', docScale: 1 };
}
...
module.exports = { read, write, addRecent, removeRecent, addFavorite, removeFavorite, setOverride, clearOverride, setSortBy, setDocScale, setWindowState, DOC_SCALE_MIN, DOC_SCALE_MAX };
