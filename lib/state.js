...
module.exports = { read, write, addRecent, removeRecent, addFavorite, removeFavorite, setSortBy, setSearchMode, setDocScale, setWindowState, setSectionOrder, setSectionCollapsed, setFavoritesOrder, setTabs, setActiveTabIndex, setAutoCheck, setAllowPrerelease, setLastUpdateCheck, setDefaultView, setActiveBrowseRoot, DOC_SCALE_MIN, DOC_SCALE_MAX, VALID_SECTIONS, DEFAULT_SECTION_ORDER, VALID_DEFAULT_VIEWS };
